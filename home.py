...
def load_models():
    ...
    label_list = ["HongNhung", "KhanhHuy", "KimLoi", "NhutAnh", "SyCuong"]
    return detector, recognizer, svc, label_list

# Initialize models
detector, recognizer, svc, label_list = load_models()
...
def recognize_frame(frame):
    ...
    for f in faces:
        ...
        if 0 <= pred < len(label_list):
            names.append(label_list[pred])
        else:
...
# Nhận diện khuôn mặt page
    ...
    if mode == "Image":
        ...
        st.sidebar.write("Use this to start/stop webcam")
